execute unless data storage minecraft:portal_pots skull.arms_up.skull.arms_up.Item run data modify storage minecraft:portal_pots skull.arms_up.skull.arms_up.Item set from block ~ ~1 ~ Items[{Slot:2b}]
