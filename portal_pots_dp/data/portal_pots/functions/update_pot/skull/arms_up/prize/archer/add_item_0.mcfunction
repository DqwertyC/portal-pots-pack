execute unless data storage minecraft:portal_pots skull.arms_up.prize.archer.Item run data modify storage minecraft:portal_pots skull.arms_up.prize.archer.Item set from block ~ ~1 ~ Items[{Slot:0b}]
