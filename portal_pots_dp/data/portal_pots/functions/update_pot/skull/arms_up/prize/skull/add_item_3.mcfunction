execute unless data storage minecraft:portal_pots skull.arms_up.prize.skull.Item run data modify storage minecraft:portal_pots skull.arms_up.prize.skull.Item set from block ~ ~1 ~ Items[{Slot:3b}]
