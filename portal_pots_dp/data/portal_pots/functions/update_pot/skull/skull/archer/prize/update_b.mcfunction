...
execute if score @s item_count < BUFFER item_count run data modify storage comparator b set from storage minecraft:portal_pots skull.skull.archer.prize.Item
execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b}}] run function portal_pots:compare/above_0
execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b,slot_0_above:0b}}] run function portal_pots:update_pot/skull/skull/archer/prize/add_item_0

execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b}}] run function portal_pots:compare/above_1
execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b,slot_1_above:0b}}] run function portal_pots:update_pot/skull/skull/archer/prize/add_item_1

execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b}}] run function portal_pots:compare/above_2
execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b,slot_2_above:0b}}] run function portal_pots:update_pot/skull/skull/archer/prize/add_item_2

execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b}}] run function portal_pots:compare/above_3
execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b,slot_3_above:0b}}] run function portal_pots:update_pot/skull/skull/archer/prize/add_item_3

execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b}}] run function portal_pots:compare/above_4
execute if score @s item_count < BUFFER item_count if entity @s[nbt={data:{grabbed:0b,slot_4_above:0b}}] run function portal_pots:update_pot/skull/skull/archer/prize/add_item_4
