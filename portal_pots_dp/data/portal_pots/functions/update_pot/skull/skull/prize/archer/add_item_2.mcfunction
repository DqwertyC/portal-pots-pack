execute unless data storage minecraft:portal_pots skull.skull.prize.archer.Item run data modify storage minecraft:portal_pots skull.skull.prize.archer.Item set from block ~ ~1 ~ Items[{Slot:2b}]
