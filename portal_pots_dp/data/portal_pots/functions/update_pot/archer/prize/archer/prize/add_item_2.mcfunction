execute unless data storage minecraft:portal_pots archer.prize.archer.prize.Item run data modify storage minecraft:portal_pots archer.prize.archer.prize.Item set from block ~ ~1 ~ Items[{Slot:2b}]
