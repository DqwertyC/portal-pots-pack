execute unless data storage minecraft:portal_pots archer.arms_up.skull.archer.Item run data modify storage minecraft:portal_pots archer.arms_up.skull.archer.Item set from block ~ ~1 ~ Items[{Slot:1b}]
