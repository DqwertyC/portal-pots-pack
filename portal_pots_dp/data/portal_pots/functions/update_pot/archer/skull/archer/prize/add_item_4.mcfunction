execute unless data storage minecraft:portal_pots archer.skull.archer.prize.Item run data modify storage minecraft:portal_pots archer.skull.archer.prize.Item set from block ~ ~1 ~ Items[{Slot:4b}]
