execute unless data storage minecraft:portal_pots archer.skull.skull.archer.Item run data modify storage minecraft:portal_pots archer.skull.skull.archer.Item set from block ~ ~1 ~ Items[{Slot:2b}]
