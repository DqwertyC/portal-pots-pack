execute unless data storage minecraft:portal_pots archer.archer.arms_up.archer.Item run data modify storage minecraft:portal_pots archer.archer.arms_up.archer.Item set from block ~ ~1 ~ Items[{Slot:3b}]
