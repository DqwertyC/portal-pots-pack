execute unless data storage minecraft:portal_pots archer.archer.arms_up.skull.Item run data modify storage minecraft:portal_pots archer.archer.arms_up.skull.Item set from block ~ ~1 ~ Items[{Slot:4b}]
