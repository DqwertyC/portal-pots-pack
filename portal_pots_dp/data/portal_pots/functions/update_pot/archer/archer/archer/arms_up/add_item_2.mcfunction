execute unless data storage minecraft:portal_pots archer.archer.archer.arms_up.Item run data modify storage minecraft:portal_pots archer.archer.archer.arms_up.Item set from block ~ ~1 ~ Items[{Slot:2b}]
