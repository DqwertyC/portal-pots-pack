execute unless data storage minecraft:portal_pots prize.skull.skull.prize.Item run data modify storage minecraft:portal_pots prize.skull.skull.prize.Item set from block ~ ~1 ~ Items[{Slot:2b}]
