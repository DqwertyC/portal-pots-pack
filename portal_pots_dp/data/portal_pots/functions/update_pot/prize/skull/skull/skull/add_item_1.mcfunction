execute unless data storage minecraft:portal_pots prize.skull.skull.skull.Item run data modify storage minecraft:portal_pots prize.skull.skull.skull.Item set from block ~ ~1 ~ Items[{Slot:1b}]
