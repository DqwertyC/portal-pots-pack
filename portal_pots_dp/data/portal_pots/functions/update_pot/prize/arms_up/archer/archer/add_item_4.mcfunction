execute unless data storage minecraft:portal_pots prize.arms_up.archer.archer.Item run data modify storage minecraft:portal_pots prize.arms_up.archer.archer.Item set from block ~ ~1 ~ Items[{Slot:4b}]
