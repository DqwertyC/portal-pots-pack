execute unless data storage minecraft:portal_pots arms_up.arms_up.archer.skull.Item run data modify storage minecraft:portal_pots arms_up.arms_up.archer.skull.Item set from block ~ ~1 ~ Items[{Slot:2b}]
