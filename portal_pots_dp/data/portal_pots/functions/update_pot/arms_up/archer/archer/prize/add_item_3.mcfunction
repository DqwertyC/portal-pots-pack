execute unless data storage minecraft:portal_pots arms_up.archer.archer.prize.Item run data modify storage minecraft:portal_pots arms_up.archer.archer.prize.Item set from block ~ ~1 ~ Items[{Slot:3b}]
