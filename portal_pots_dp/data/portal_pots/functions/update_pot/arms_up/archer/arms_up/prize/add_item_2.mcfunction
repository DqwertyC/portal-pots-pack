execute unless data storage minecraft:portal_pots arms_up.archer.arms_up.prize.Item run data modify storage minecraft:portal_pots arms_up.archer.arms_up.prize.Item set from block ~ ~1 ~ Items[{Slot:2b}]
