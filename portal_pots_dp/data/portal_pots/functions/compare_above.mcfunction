...
execute store success storage minecraft:comparator result byte 1 run data modify storage minecraft:comparator a set from storage minecraft:comparator b